...
#                                                                                                  #
#    Example: python3 -u rq1_participation.py                                                      #
#                                                                                                  #
####################################################################################################
...
# - Target Name: Target-HaveParticipation                                                          #
# - Evaluated undersampling rates for the majority class (Target-HaveParticipation=FALSE)          #
# - File where results are written                                                                 #
#                                                                                                  #
# In this Research Question, we evaluate how the prediction for Target-HaveParticipation is        #
...
OUTPUT_CSV_FILE_NAME = 'rq1_participation_results.csv'
